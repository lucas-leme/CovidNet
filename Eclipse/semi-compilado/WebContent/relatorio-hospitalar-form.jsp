    ...
    <div align="center">
        ...
        <table border="1">
            <caption>
        		...
        		<c:if test="${relatorio != null}">
        			<input type="hidden" name="id" value="<c:out value='${relatorioMunicipal.id}' />" />
        		</c:if>            
            <tr>
                <th>Nome Estado: </th>
                <td>
                	<input type="text" name="nomeEstado" size="45"
                			value="<c:out value='${relatorioMunicipal.nomeMunicipio}' />"
                		/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                	<input type="text" name="numeroHospitais" size="15"
                			value="<c:out value='${relatorioMunicipal.numeroHospitais}' />"
                	/>
                </td>
            </tr>
            <tr>
